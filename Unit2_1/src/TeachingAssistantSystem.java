...
public class TeachingAssistantSystem {
	...
	public void displayTask(int taskCode) throws IOException {
		...
		stdErr.println("Please enter corrected task code!");
	}
	...
	public void displayTaskList(int studentCode) {
		...
		for (Student student : studentDatabase) {
			if (student.getCode() == studentCode) {
				for (TaskScore taskScore : student.getTaskScoreList())
					stdOut.println(taskScore.toString());
				return;
			}
		}

		stdErr.println("Please enter the correct student code!");
	}
