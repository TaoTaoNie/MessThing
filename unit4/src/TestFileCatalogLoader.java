		...
		try {
			...
			assertTrue(
					"2, testing method read with an empty file"
							+ emptyCatalog.getProductList().size()
							+ " products loaded", emptyCatalog.getProductList()
							.size() == 0);
			...
			assertTrue("4, testing method loadCatalog: "
					+ catalog.getProductList().size() + " products loaded",
			...
			assertTrue("5, testing method loadCatalog" + product.toString(),
					product instanceof Yogurt);

			Yogurt yogurtC001 = (Yogurt) product;

			SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
			assertTrue("6, testing method loadCatalog: "
					+ yogurtC001.toString(), yogurtC001.getCode()
					.equals("C001")
					&& yogurtC001.getDescription().equals(
							"chocolate flavor,270ml")
					&& yogurtC001.getPrice().equals(new BigDecimal("5"))
					&& yogurtC001.getProductionDate().equals(
							sdf.parse("2017-10-20"))
			...
			assertTrue("8, testing method loadCatalog: "
					+ yogurtC002.toString(), yogurtC002.getCode()
					.equals("C002")
					&& yogurtC002.getDescription().equals(
							"strawberry flavor,400ml")
					&& yogurtC002.getPrice().equals(new BigDecimal("10"))
					&& yogurtC002.getProductionDate().equals(
							sdf.parse("2017-10-20"))
			...
			assertTrue("11, testing method loadCatalog: " + product.toString(),
					product instanceof Jelly);

			Jelly productB002 = (Jelly) product;

			assertTrue("12, testing method loadCatalog: "
					+ productB002.toString(), productB002.getCode().equals(
					"B002")
					&& productB002.getDescription().equals("solid,400ml"));
