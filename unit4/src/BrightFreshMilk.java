...
public class BrightFreshMilk {
    ...
    private void loadSales() {
        ...
        orderItemListTwo
                .add(new OrderItem(catalog.findProductByCode("C002"), 2));
        orderItemListTwo
                .add(new OrderItem(catalog.findProductByCode("A001"), 2));
        ...
        orderItemListThree.add(new OrderItem(catalog.findProductByCode("B002"),
                1));
    ...
    private void run() throws IOException {
        ...
        while (choice != 0) {
            if (choice == 1) {
                ...
                this.salesFormatter = PlainTextSalesFormatter
                        .getSingletonInstance();
                writeFile(readFilename(), this.salesFormatter
                        .formatSales(this.sales));
            } else if (choice == 3) {
